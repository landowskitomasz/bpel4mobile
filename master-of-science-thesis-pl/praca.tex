...
\supervisor{dr hab. inż. Grzegorz J. Nalepa}
...
\acknowledgements{Serdecznie dziękuję Panu dr hab. inż. Grzegorz J. Nalepa, za poświęcony czas i cenne wskazówki, które przyczyniły się do powstania niniejszej pracy magisterskiej.}
...
\bibitem{ContextAwareMobility}
2008 Cisco Systems, Inc.
\newblock {\em {Cisco Context-Aware Mobility Solution}}.
...
\newblock {\em {Business Process Model and Notation}}
\newblock \\\texttt{http://www.bpmn.org/}

\bibitem{ode}
Apache Software Foundation
\newblock {\em {Apache ODE Home Page}}
...
\bibitem{context-aware-middleware}
Daniel Romero
\newblock  {\em {Context-Aware Middleware: An overview}}
...
\newblock  {\em {Spring Framework. Profesjonalne tworzenie oprogramowania w Javie}}
...
\newblock  {\em {Apache Maven Project}}
