...
import com.bpel4mobile.hotel.android.activity.LoginActivity;
...
public class SessionManager {
    ...
    /**
     * Clear session details and navigate to login activity.
     * */
	...
	public Account getCurrentUser() {
		...
		Account account = new Account(userDetails.get(KEY_LOGIN), AuthenticationService.CLEAN_UP_SYSTEM_USER_TYPE);
		return account;
	}
}
